...
# Save as CSV
confirmed_df.to_csv("covid_confirmed_cases.csv")
deaths_df.to_csv("covid_deaths_cases.csv")
...
# Insert confirmed_df data into the "confirmed_timeseries" table in "Covid" db
